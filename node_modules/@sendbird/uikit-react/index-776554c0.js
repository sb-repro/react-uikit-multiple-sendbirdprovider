...
var getMimeTypesUIKitAccepts = function (acceptableMimeTypes) {
  var IMAGE = SUPPORTED_MIMES.IMAGE,
    VIDEO = SUPPORTED_MIMES.VIDEO,
    AUDIO = SUPPORTED_MIMES.AUDIO;
  if (Array.isArray(acceptableMimeTypes) && acceptableMimeTypes.length > 0) {
    return acceptableMimeTypes.reduce(function (accumulator, acceptableMimeType) {
      return accumulator.concat(K(acceptableMimeType).with('image', function () {
        return IMAGE;
      }).with('video', function () {
        return VIDEO;
      }).with('audio', function () {
...
export { getUIKitMessageTypes as A, getSenderName as B, isOGMessage as C, isTextMessage as D, isSupportedFileView as E, isUrl as F, isEditedMessage as G, isSentMessage as H, isFailedMessage as I, isPendingMessage as J, copyToClipboard as K, getEmojiListAll as L, getEmojiUrl as M, isReactedBy as N, getEmojiTooltipString as O, getEmojiMapAll as P, getUIKitFileType as Q, truncateString as R, getUIKitFileTypes as S, isThreadMessage as T, UIKitMessageTypes as U, convertWordToStringObj as V, StringObjType as W, isSendableMessage as a, filterMessageListParams as b, isMultipleFilesMessage as c, isVoiceMessage as d, isReadMessage as e, filterChannelListParams as f, getChannelsWithUpsertedChannel as g, isImage as h, isTextuallyNull as i, isGif as j, isVideo as k, isAudio as l, isVoiceMessageMimeType as m, isSentStatus as n, getClassName as o, arrayEqual as p, getMimeTypesUIKitAccepts as q, isFileMessage as r, isImageMessage as s, isVideoMessage as t, isImageFileInfo as u, isThumbnailMessage as v, isAudioMessage as w, isGifMessage as x, isUserMessage as y, getUIKitMessageType as z };
//# sourceMappingURL=index-776554c0.js.map
