...
function reducer(state, action) {
  ...
  switch (action.type) {
    ...
    case OpenChannelListActionTypes$1.FETCH_OPEN_CHANNEL_LIST_SUCCESS:
      {
        return __assign(__assign({}, state), {
          allChannels: __spreadArray(__spreadArray([], state.allChannels, true), action.payload, true)
        });
      }
    ...
    case OpenChannelListActionTypes$1.CREATE_OPEN_CHANNEL:
      {
        return __assign(__assign({}, state), {
          ...
          allChannels: __spreadArray([action.payload], state.allChannels, true)
        });
      }
...
var OpenChannelListContext = /*#__PURE__*/React__default.createContext({
...
var OpenChannelListProvider = function (_a) {
  ...
  // dux
  var _e = useReducer(reducer, openChannelListInitialState),
  ...
  useEffect(function () {
    ...
    subscriber === null || subscriber === void 0 ? void 0 : subscriber.set(PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe(PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, function (channel) {
      openChannelListDispatcher({
...
//# sourceMappingURL=OpenChannelListProvider-45d4ab54.js.map
