...
var ImageRenderer = function (_a) {
  var _b = _a.className,
    ...
    _m = _a.onLoad,
    onLoad = _m === void 0 ? function () {} : _m,
    _o = _a.onError,
    onError = _o === void 0 ? function () {} : _o,
    shadeOnHover = _a.shadeOnHover,
    _p = _a.isUploaded,
    isUploaded = _p === void 0 ? true : _p;
  var _q = useState(false),
    showDefaultComponent = _q[0],
    setShowDefaultComponent = _q[1];
  var _r = useState(true),
    showPlaceHolder = _r[0],
    setShowPlaceHolder = _r[1];
  ...
  return dynamicMinWidth && dynamicMinHeight && /*#__PURE__*/React__default.createElement("div", {
  ...
  }), HiddenImageLoader, shadeOnHover && /*#__PURE__*/React__default.createElement("div", {
