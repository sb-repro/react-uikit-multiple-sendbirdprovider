    ...
    if (pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe) {
      ...
      subscriber.set(PUBSUB_TOPICS.ON_FILE_INFO_UPLOADED, pubSub.subscribe(PUBSUB_TOPICS.ON_FILE_INFO_UPLOADED, function (props) {
        var _a = props,
          ...
          publishingModules = _a.publishingModules;
        if ((currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.url) === response.channelUrl && publishingModules.includes(PublishingModuleType.THREAD)) {
          threadDispatcher({
      ...
      subscriber.set(PUBSUB_TOPICS.SEND_FILE_MESSAGE, pubSub.subscribe(PUBSUB_TOPICS.SEND_FILE_MESSAGE, function (props) {
        var _a = props,
          ...
          message = _a.message,
          publishingModules = _a.publishingModules;
        if ((currentChannel === null || currentChannel === void 0 ? void 0 : currentChannel.url) === (channel === null || channel === void 0 ? void 0 : channel.url) && publishingModules.includes(PublishingModuleType.THREAD)) {
          threadDispatcher({
            type: ThreadContextActionTypes.SEND_MESSAGE_SUCESS,
            payload: {
              message: message
