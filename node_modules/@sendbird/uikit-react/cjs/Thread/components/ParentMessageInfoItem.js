...
var index$1 = require('../../index-ce07a2a3.js');
...
function ParentMessageInfoItem(_a) {
  ...
  var _l = (useSendbirdStateContext.useSendbirdStateContext === null || useSendbirdStateContext.useSendbirdStateContext === void 0 ? void 0 : useSendbirdStateContext.useSendbirdStateContext()) || {},
    stores = _l.stores,
    config = _l.config,
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  }, " ".concat(stringSet.MESSAGE_EDITED, " "))), index.getUIKitMessageType(message) === index.getUIKitMessageTypes().FILE && /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    type: ui_Label.LabelTypography.BODY_1,
    color: ui_Label.LabelColors.ONBACKGROUND_1
  }, index.truncateString((message === null || message === void 0 ? void 0 : message.name) || (message === null || message === void 0 ? void 0 : message.url), 30)))), index.isMultipleFilesMessage(message) && /*#__PURE__*/React__default["default"].createElement(useStatefulFileInfoList.MultipleFilesMessageItemBody, {
  ...
  }), index.isVoiceMessage(message) && /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    width: "34px",
    height: "34px"
  })))), index.getUIKitMessageType(message) === ((_k = index.getUIKitMessageTypes === null || index.getUIKitMessageTypes === void 0 ? void 0 : index.getUIKitMessageTypes()) === null || _k === void 0 ? void 0 : _k.UNKNOWN) && /*#__PURE__*/React__default["default"].createElement("div", {
