...
var pubSubHandler = function (pubSub, channelListDispatcher) {
  ...
  subscriber.set(pubSub_topics.PUBSUB_TOPICS.CREATE_CHANNEL, pubSub.subscribe(pubSub_topics.PUBSUB_TOPICS.CREATE_CHANNEL, function (msg) {
  ...
  subscriber.set(pubSub_topics.PUBSUB_TOPICS.LEAVE_CHANNEL, pubSub.subscribe(pubSub_topics.PUBSUB_TOPICS.LEAVE_CHANNEL, function (msg) {
    var channel = msg.channel;
    channelListDispatcher({
...
function channelListReducer(state, action) {
  return index.K(action).with({
    ...
    return tslib_es6.__assign(tslib_es6.__assign({}, state), {
      allChannels: tslib_es6.__spreadArray(tslib_es6.__spreadArray([], state.allChannels, true), filteredChannels, true)
    });
  }).with({
    type: CREATE_CHANNEL
  }, function (action) {
    ...
    if (channelListQuery) {
      if (index$1.filterChannelListParams(channelListQuery, channel, currentUserId)) {
        ...
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          ...
          allChannels: index$1.getChannelsWithUpsertedChannel(allChannels, channel)
        });
      }
    ...
    return tslib_es6.__assign(tslib_es6.__assign({}, state), {
      currentChannel: channel,
      allChannels: tslib_es6.__spreadArray([channel], allChannels.filter(function (ch) {
  ...
  .with({
    ...
    type: index.S.union(LEAVE_CHANNEL_SUCCESS, ON_CHANNEL_DELETED)
  }, function (action) {
    var _a;
    ...
    return tslib_es6.__assign(tslib_es6.__assign({}, state), {
      ...
      allChannels: state.allChannels.filter(function (_a) {
        var url = _a.url;
    ...
    var _a, _b;
    var channel = action.payload;
    var _c = state.allChannels,
      allChannels = _c === void 0 ? [] : _c,
      currentUserId = state.currentUserId,
      currentChannel = state.currentChannel,
      channelListQuery = state.channelListQuery,
      disableAutoSelect = state.disableAutoSelect;
    ...
    if (action.type === ON_USER_JOINED && !(channel === null || channel === void 0 ? void 0 : channel.lastMessage)) return state;
    if (channelListQuery) {
      if (index$1.filterChannelListParams(channelListQuery, channel, currentUserId)) {
        // Good to [add to/keep in] the ChannelList
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
    ...
    // Move to the top
    return tslib_es6.__assign(tslib_es6.__assign({}, state), {
      allChannels: tslib_es6.__spreadArray([channel], allChannels.filter(function (_a) {
        var url = _a.url;
    ...
    if (state.channelListQuery) {
      if (index$1.filterChannelListParams(state.channelListQuery, action.payload, state.currentUserId)) {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          allChannels: tslib_es6.__spreadArray([action.payload], state.allChannels.filter(function (channel) {
...
var ChannelListProvider = function (props) {
  ...
  var markAsDeliveredScheduler = config.markAsDeliveredScheduler,
    ...
    _f = config.isTypingIndicatorEnabledOnChannelList,
    isTypingIndicatorEnabledOnChannelList = _f === void 0 ? false : _f,
    _g = config.isMessageReceiptStatusEnabledOnChannelList,
    isMessageReceiptStatusEnabledOnChannelList = _g === void 0 ? false : _g;
  var sdk = sdkStore === null || sdkStore === void 0 ? void 0 : sdkStore.sdk;
  var _h = ((_a = sdk === null || sdk === void 0 ? void 0 : sdk.appInfo) !== null && _a !== void 0 ? _a : {}).premiumFeatureList,
    premiumFeatureList = _h === void 0 ? [] : _h;
  ...
  var _j = React.useReducer(channelListReducer, initialState),
    channelListStore = _j[0],
    channelListDispatcher = _j[1];
  var currentChannel = channelListStore.currentChannel;
  var _k = React.useState(null),
    channelSource = _k[0],
    setChannelSource = _k[1];
  var _l = React.useState([]),
    typingChannels = _l[0],
    setTypingChannels = _l[1];
  ...
  var fetchChannelList = useFetchChannelList({
    ...
    disableMarkAsDelivered: disableMarkAsDelivered || !premiumFeatureList.some(function (feature) {
      return feature === consts.DELIVERY_RECEIPT;
    })
  }, {
    channelListDispatcher: channelListDispatcher,
    logger: logger,
...
//# sourceMappingURL=ChannelListProvider-d0ad5a84.js.map
