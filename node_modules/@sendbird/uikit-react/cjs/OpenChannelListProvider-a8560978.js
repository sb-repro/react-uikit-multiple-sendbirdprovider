...
function reducer(state, action) {
  ...
  switch (action.type) {
    case OpenChannelListActionTypes$1.INIT_OPEN_CHANNEL_LIST_START:
      {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          fetchingStatus: exports.OpenChannelListFetchingStatus.FETCHING
        });
      }
    case OpenChannelListActionTypes$1.INIT_OPEN_CHANNEL_LIST_SUCCESS:
      {
        ...
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          ...
          fetchingStatus: channelList.length > 0 ? exports.OpenChannelListFetchingStatus.DONE : exports.OpenChannelListFetchingStatus.EMPTY
        });
      }
    case OpenChannelListActionTypes$1.INIT_OPEN_CHANNEL_LIST_FAILURE:
      {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          allChannels: [],
          fetchingStatus: exports.OpenChannelListFetchingStatus.ERROR
        });
      }
    ...
    case OpenChannelListActionTypes$1.FETCH_OPEN_CHANNEL_LIST_SUCCESS:
      {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          allChannels: tslib_es6.__spreadArray(tslib_es6.__spreadArray([], state.allChannels, true), action.payload, true)
        });
      }
    ...
    case OpenChannelListActionTypes$1.CREATE_OPEN_CHANNEL:
      {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          ...
          allChannels: tslib_es6.__spreadArray([action.payload], state.allChannels, true)
        });
      }
    ...
    case OpenChannelListActionTypes$1.UPDATE_OPEN_CHANNEL:
      {
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          ...
          currentChannel: ((_a = state.currentChannel) === null || _a === void 0 ? void 0 : _a.url) === ((_b = action === null || action === void 0 ? void 0 : action.payload) === null || _b === void 0 ? void 0 : _b.url) ? state.currentChannel : action.payload
        });
      }
    default:
      {
...
function useFetchNextCallback(_a, _b) {
  var sdkInitialized = _a.sdkInitialized,
    openChannelListQuery = _a.openChannelListQuery;
  var logger = _b.logger,
    openChannelListDispatcher = _b.openChannelListDispatcher;
  return React.useCallback(function (callback) {
    if (sdkInitialized && (openChannelListQuery === null || openChannelListQuery === void 0 ? void 0 : openChannelListQuery.hasNext)) {
      ...
      openChannelListQuery.next().then(function (channelList) {
...
function createChannelListQuery(_a) {
  var _b, _c;
  var sdk = _a.sdk,
    logMessage = _a.logMessage,
    openChannelListQuery = _a.openChannelListQuery,
    logger = _a.logger,
    openChannelListDispatcher = _a.openChannelListDispatcher;
  var params = {};
  params.limit = 20;
...
function useSetupOpenChannelList(_a, _b) {
  var sdk = _a.sdk,
    sdkInitialized = _a.sdkInitialized,
    openChannelListQuery = _a.openChannelListQuery;
  var logger = _b.logger,
    openChannelListDispatcher = _b.openChannelListDispatcher;
...
var OpenChannelListContext = /*#__PURE__*/React__default["default"].createContext({
...
var OpenChannelListProvider = function (_a) {
  ...
  // props
  var _d = useSendbirdStateContext.useSendbirdStateContext(),
    stores = _d.stores,
    config = _d.config;
  ...
  // dux
  var _e = React.useReducer(reducer, openChannelListInitialState),
    openChannelListStore = _e[0],
    openChannelListDispatcher = _e[1];
  var allChannels = openChannelListStore.allChannels,
    currentChannel = openChannelListStore.currentChannel,
    fetchingStatus = openChannelListStore.fetchingStatus,
    channelListQuery = openChannelListStore.channelListQuery;
  // Initialize
  ...
  React.useEffect(function () {
    ...
    subscriber === null || subscriber === void 0 ? void 0 : subscriber.set(pubSub_topics.PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe(pubSub_topics.PUBSUB_TOPICS.UPDATE_OPEN_CHANNEL, function (channel) {
      openChannelListDispatcher({
  ...
  return /*#__PURE__*/React__default["default"].createElement(OpenChannelListContext.Provider, {
    ...
    className: "sendbird-open-channel-list ".concat(className)
  }, children));
};
...
//# sourceMappingURL=OpenChannelListProvider-a8560978.js.map
