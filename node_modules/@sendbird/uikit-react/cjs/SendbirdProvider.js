...
var actionTypes = require('./actionTypes-327123b5.js');
...
var stringSet = require('./stringSet-1539ac47.js');
...
function useOnlineStatus(sdk, logger) {
  var _a, _b;
  var _c = React.useState((_b = (_a = window === null || window === void 0 ? void 0 : window.navigator) === null || _a === void 0 ? void 0 : _a.onLine) !== null && _b !== void 0 ? _b : true),
    isOnline = _c[0],
    setIsOnline = _c[1];
...
var INIT_USER = actionTypes.USER_ACTIONS.INIT_USER,
  UPDATE_USER_INFO = actionTypes.USER_ACTIONS.UPDATE_USER_INFO,
  RESET_USER = actionTypes.USER_ACTIONS.RESET_USER;
...
function setUpParams(_a) {
  ...
  var params = tslib_es6.__assign(tslib_es6.__assign({
  ...
  var newSdk = SendbirdChat__default["default"].init(params);
  return newSdk;
}
// Steps
      ...
      return [2 /*return*/, new Promise(function (resolve, reject) {
        ...
        if (userId && appId) {
          ...
          (_d = newSdk_1 === null || newSdk_1 === void 0 ? void 0 : newSdk_1.addSendbirdExtensions) === null || _d === void 0 ? void 0 : _d.call(newSdk_1, [{
            product: (_e = SendbirdChat.SendbirdProduct === null || SendbirdChat.SendbirdProduct === void 0 ? void 0 : SendbirdChat.SendbirdProduct.UIKIT_CHAT) !== null && _e !== void 0 ? _e : 'uikit-chat',
            version: APP_VERSION_STRING,
            platform: (_f = SendbirdChat.SendbirdPlatform === null || SendbirdChat.SendbirdPlatform === void 0 ? void 0 : SendbirdChat.SendbirdPlatform.JS) !== null && _f !== void 0 ? _f : 'js'
          }], {
            platform: isMobile ? (_g = SendbirdChat.DeviceOsPlatform === null || SendbirdChat.DeviceOsPlatform === void 0 ? void 0 : SendbirdChat.DeviceOsPlatform.MOBILE_WEB) !== null && _g !== void 0 ? _g : 'mobile_web' : (_h = SendbirdChat.DeviceOsPlatform === null || SendbirdChat.DeviceOsPlatform === void 0 ? void 0 : SendbirdChat.DeviceOsPlatform.WEB) !== null && _h !== void 0 ? _h : 'web'
          ...
          var connectCbSucess_1 = function (user) {
            return tslib_es6.__awaiter(_this, void 0, void 0, function () {
              ...
              return tslib_es6.__generator(this, function (_c) {
                ...
                if ((nickname !== user.nickname || profileUrl !== user.profileUrl) && !(index$1.isTextuallyNull(nickname) && index$1.isTextuallyNull(profileUrl))) {
...
function useConnect(triggerTypes, staticTypes) {
  ...
  (_a = logger === null || logger === void 0 ? void 0 : logger.info) === null || _a === void 0 ? void 0 : _a.call(logger, 'SendbirdProvider | useConnect', tslib_es6.__assign(tslib_es6.__assign({}, triggerTypes), staticTypes));
  React.useEffect(function () {
    var _a, _b;
...
var printLog = function (_a) {
  ...
  console.log.apply(console, tslib_es6.__spreadArray(["%c SendbirdUIKit | ".concat(level, " | ").concat(new Date().toISOString(), " | ").concat(title, " ").concat(description && '|'), colorLog(level), description], payload, false));
};
...
var LoggerFactory = function (lvl, customInterface) {
  ...
  return lvlArray.reduce(function (accumulator, currentLvl) {
    if (currentLvl === LOG_LEVELS.DEBUG || currentLvl === LOG_LEVELS.ALL) {
      return tslib_es6.__assign(tslib_es6.__assign({}, accumulator), {
    ...
    return tslib_es6.__assign({}, accumulator);
  }, getDefaultLogger());
};
...
function useMarkAsReadScheduler(_a, _b) {
  ...
  var markAsReadScheduler = React.useMemo(function () {
...
function useMarkAsDeliveredScheduler(_a, _b) {
  var isConnected = _a.isConnected;
  var logger = _b.logger;
  var markAsDeliveredScheduler = React.useMemo(function () {
    return schedulerFactory({
      logger: logger,
      cb: function (channel) {
        try {
...
var SendbirdSDK = function (_a) {
  ...
  var _3 = React.useState(LoggerFactory(logLevel)),
    logger = _3[0],
    setLogger = _3[1];
  var pubSub = React.useState(function () {
    return customPubSub !== null && customPubSub !== void 0 ? customPubSub : pubSubFactory();
  })[0];
  var _4 = React.useReducer(reducer$1, initialState$1),
    sdkStore = _4[0],
    sdkDispatcher = _4[1];
  var _5 = React.useReducer(reducer, initialState),
    userStore = _5[0],
    userDispatcher = _5[1];
  var _6 = uikitTools.useUIKitConfig(),
    configs = _6.configs,
  ...
  var localeStringSet = React__default["default"].useMemo(function () {
    ...
    return tslib_es6.__assign(tslib_es6.__assign({}, stringSet.getStringSet('en')), stringSet$1);
  }, [stringSet$1]);
  /**
  ...
  return /*#__PURE__*/React__default["default"].createElement(withSendbird.SendbirdSdkContext.Provider, {
    value: {
      ...
      config: {
        ...
        logger: logger,
        pubSub: pubSub,
        imageCompression: tslib_es6.__assign({
          compressionRate: 0.7
        }, imageCompression),
        voiceRecord: {
    ...
    isVoiceMessageEnabled: configs.groupChannel.channel.enableVoiceMessage
  }, /*#__PURE__*/React__default["default"].createElement(hooks_useModal.GlobalModalProvider, null, children)))));
};
