    ...
    case GET_NEXT_SEARCHED_MESSAGES:
      {
        ...
        return tslib_es6.__assign(tslib_es6.__assign({}, state), {
          allMessages: tslib_es6.__spreadArray(tslib_es6.__spreadArray([], state.allMessages, true), messages, true),
          hasMoreResult: (state === null || state === void 0 ? void 0 : state.currentMessageSearchQuery).hasNext
        });
      }
    ...
    if (sdk && channelUrl && sdk.createMessageSearchQuery && currentChannel) {
      if (requestString) {
        currentChannel.refresh().then(function (channel) {
          var inputSearchMessageQueryObject = tslib_es6.__assign({
...
var MessageSearchContext = /*#__PURE__*/React__default["default"].createContext(undefined);
...
var useMessageSearchContext = function () {
  return React__default["default"].useContext(MessageSearchContext);
};
