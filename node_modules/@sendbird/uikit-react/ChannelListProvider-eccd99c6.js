...
import { b as DELIVERY_RECEIPT$1 } from './consts-d9c5f25a.js';
import { U as UserProfileProvider } from './UserProfileContext-2001a468.js';
import { useSendbirdStateContext } from './useSendbirdStateContext.js';
import { K, S } from './index-09847c0f.js';
import { f as filterChannelListParams, g as getChannelsWithUpsertedChannel } from './index-776554c0.js';
  ...
  .with({
    ...
    if (state.channelListQuery) {
      if (filterChannelListParams(state.channelListQuery, action.payload, state.currentUserId)) {
        return __assign(__assign({}, state), {
          allChannels: __spreadArray([action.payload], state.allChannels.filter(function (channel) {
...
var ChannelListProvider = function (props) {
  ...
  var _j = useReducer(channelListReducer, initialState),
...
//# sourceMappingURL=ChannelListProvider-eccd99c6.js.map
